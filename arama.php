...
?>
    ...
    <div class="site-section site-section-sm bg-light">
      <div class="container">
        ...
        <div class="row mb-5">
         <?php
if (isset($_POST['emlaktip'])) {


$emlak=$baglanti->prepare("SELECT * from emlak where emlaktipi=:emlaktipi and fiyat>:dusukfiyat 
  and fiyat<:yuksekfiyat ");


$emlak->execute(array(

'emlaktipi'=>$_POST['emlaktip'],
'dusukfiyat'=>$_POST['dusukfiyat'],
'yuksekfiyat'=>$_POST['yuksekfiyat']
